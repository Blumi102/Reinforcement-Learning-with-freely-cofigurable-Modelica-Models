package Pendel
  model Pendelum
    ...
    Komponenten.Pendulum pendulum(m_trolley=5, phi1_start=1.5882496193148)
      annotation (Placement(transformation(extent={{-26,0},{4,20}})));
  equation
    connect(pendulum.u, const.y) annotation (Line(
        points={{-28,10},{-71,10}},
        color={0,0,127},
        smooth=Smooth.None));
